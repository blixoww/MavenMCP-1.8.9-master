...
public class Block {
    ...
    public static void registerBlocks() {
        ...
        // ── Minerais custom ───────────────────────────────────────────────────────
        registerBlock(198, "ruby_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypeStone).setUnlocalizedName("oreRuby").setCreativeTab(CreativeTabs.tabBlock));
        registerBlock(199, "cobalt_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypeStone).setUnlocalizedName("oreCobalt").setCreativeTab(CreativeTabs.tabBlock));
        registerBlock(200, "steel_chest", (new BlockSteelChest()).setUnlocalizedName("steelChest"));

        registerBlock(201, "steel_block", (new Block(Material.iron, MapColor.ironColor)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setUnlocalizedName("steel_block").setCreativeTab(CreativeTabs.tabBlock));
