...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void registerItems()
    {
        ...
        this.registerBlock(Blocks.steel_anvil, "steel_anvil");
        this.registerBlock(Blocks.steel_anvil, 1, "steel_anvil_slightly_damaged");
        this.registerBlock(Blocks.steel_anvil, 2, "steel_anvil_very_damaged");
        ...
        this.registerItem(Items.emerald_helmet, "emerald_helmet");
        this.registerItem(Items.emerald_chestplate, "emerald_chestplate");
        this.registerItem(Items.emerald_leggings, "emerald_leggings");
        this.registerItem(Items.emerald_boots, "emerald_boots");
        ...
        this.registerItem(Items.cobalt_sword, "cobalt_sword");
        this.registerItem(Items.cobalt_helmet, "cobalt_helmet");
        this.registerItem(Items.cobalt_chestplate, "cobalt_chestplate");
        this.registerItem(Items.cobalt_leggings, "cobalt_leggings");
        this.registerItem(Items.cobalt_boots, "cobalt_boots");
        this.registerItem(Items.cobalt_shovel, "cobalt_shovel");
        this.registerItem(Items.cobalt_pickaxe, "cobalt_pickaxe");
        this.registerItem(Items.cobalt_axe, "cobalt_axe");
        this.registerItem(Items.cobalt_hoe, "cobalt_hoe");


        this.registerBlock(Blocks.ruby_ore, "ruby_ore");
        this.registerBlock(Blocks.cobalt_ore, "cobalt_ore");
        this.registerBlock(Blocks.steel_block, "steel_block");
        this.registerBlock(Blocks.ruby_block, "ruby_block");
        this.registerBlock(Blocks.cobalt_block, "cobalt_block");
        this.registerBlock(Blocks.steel_chest, "steel_chest");
