...
public class GuiControls extends GuiScreen {
    ...
    @Override
    public void initGui() {
        // Ajouter les boutons existants en haut (comme vanilla)
        int i = 0;
        ...
        // Placer la barre de recherche EN DESSOUS des options
        // Les options finissent vers y = 18 + 24 + 20 = 62. On met la recherche à y=75.
        if (this.searchField == null) {
            this.searchField = new GuiTextField(0, this.fontRendererObj, this.width / 2 - 150, 75, 300, 20);
            this.searchField.setMaxStringLength(50);
        } else {
            // Mise à jour position si redimensionnement
            this.searchField.xPosition = this.width / 2 - 150;
            this.searchField.yPosition = 75;
        }
        ...
        this.buttonList.add(this.buttonReset = new GuiButton(201, this.width / 2 - 155 + 160, this.height - 29, 100, 20, I18n.format("controls.resetAll")));
        this.buttonList.add(new GuiButton(202, this.width / 2 - 155 + 265, this.height - 29, 90, 20, "§6Macros..."));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        // Afficher la liste filtrée (en arrière plan par rapport aux boutons du haut si overlap, mais ici elle est en dessous)
        this.keyBindingList.drawScreen(mouseX, mouseY, partialTicks);

        // Afficher le titre
        this.drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 8, 16777215);

        // Afficher le label de recherche juste au-dessus du champ (y=75 -> label vers 63)
        this.drawCenteredString(this.fontRendererObj, "Recherche", this.width / 2, 63, 0xFFFFFF);
        ...
        // Appel super pour dessiner les boutons (options en haut, done/reset en bas)
