...
public class GuiSteelRepair extends GuiContainer implements ICrafting
{
    private static final ResourceLocation anvilResource = new ResourceLocation("textures/gui/container/anvil.png");
    private ContainerSteelRepair anvil;
    private GuiTextField nameField;
    private InventoryPlayer playerInventory;

    public GuiSteelRepair(InventoryPlayer inventoryIn, World worldIn)
    {
        super(new ContainerSteelRepair(inventoryIn, worldIn, Minecraft.getMinecraft().thePlayer));
        this.playerInventory = inventoryIn;
        this.anvil = (ContainerSteelRepair)this.inventorySlots;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (this.anvil.maximumCost > 0)
        {
            ...
            // Steel anvil: never show "too expensive" — always display cost in green/normal color
