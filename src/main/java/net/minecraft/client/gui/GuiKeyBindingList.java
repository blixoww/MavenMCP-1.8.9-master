...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    {
        // Appel à super en première instruction ; calculer top dynamiquement ici
        ...
        // Filtrage selon la recherche (ou tout afficher si recherche vide)
