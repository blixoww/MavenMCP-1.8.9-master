...
public class ModelBakery
{
    ...
    private void registerVariantNames()
    {
        ...
        this.variantNames.put(Item.getItemFromBlock(Blocks.steel_anvil), Lists.newArrayList(new String[] {"steel_anvil", "steel_anvil_slightly_damaged", "steel_anvil_very_damaged"}));
