...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void displayGUIChest(IInventory chestInventory) {
        ...
        } else if ("minecraft:steel_chest".equals(s) && chestInventory instanceof net.minecraft.tileentity.TileEntitySteelChest) {
            net.minecraft.tileentity.TileEntitySteelChest sc = (net.minecraft.tileentity.TileEntitySteelChest) chestInventory;
            this.mc.displayGuiScreen(new net.minecraft.client.gui.inventory.GuiSteelChest(
                    new net.minecraft.inventory.ContainerSteelChest(this.inventory, sc, this), sc));
