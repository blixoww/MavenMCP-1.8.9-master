    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                ...
                {
                    // Déclenchement Hit Marker sur le client
                    if (this.worldObj.isRemote && this.shootingEntity == Minecraft.getMinecraft().thePlayer) {
                        net.minecraft.client.visuals.VisualManager.getInstance().onArrowHit();
                    }
