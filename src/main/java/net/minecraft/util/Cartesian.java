    ...
    static class Product<T> implements Iterable<T[]>
    {
        ...
        public Iterator<T[]> iterator()
        {
            if (this.iterables.length <= 0) {
                return (Iterator<T[]>)(Iterator)Collections.singletonList(Cartesian.createArray(this.clazz, 0)).iterator();
            }
            return (Iterator<T[]>)(Iterator)new Cartesian.Product.ProductIterator(this.clazz, this.iterables);
        }
