...
public class Item {
    ...
    public static void registerItems() {
        ...
        // Steel items
        registerItem(432, "steel_sword", (new ItemSword(Item.ToolMaterial.STEEL)).setUnlocalizedName("steel_sword"));
        registerItem(433, "steel_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.STEEL, 5, 0)).setUnlocalizedName("steel_helmet"));
        registerItem(434, "steel_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.STEEL, 5, 1)).setUnlocalizedName("steel_chestplate"));
        registerItem(435, "steel_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.STEEL, 5, 2)).setUnlocalizedName("steel_leggings"));
        registerItem(436, "steel_boots", (new ItemArmor(ItemArmor.ArmorMaterial.STEEL, 5, 3)).setUnlocalizedName("steel_boots"));

        // Emerald items (custom)
        registerItem(437, "emerald_sword", (new ItemSword(Item.ToolMaterial.EMERALD)).setUnlocalizedName("emerald_sword"));
        registerItem(438, "emerald_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.EMERALD, 6, 0)).setUnlocalizedName("emerald_helmet"));
        registerItem(439, "emerald_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.EMERALD, 6, 1)).setUnlocalizedName("emerald_chestplate"));
        registerItem(440, "emerald_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.EMERALD, 6, 2)).setUnlocalizedName("emerald_leggings"));
        registerItem(441, "emerald_boots", (new ItemArmor(ItemArmor.ArmorMaterial.EMERALD, 6, 3)).setUnlocalizedName("emerald_boots"));

        // Ruby items
        registerItem(442, "ruby_sword", (new ItemSword(Item.ToolMaterial.RUBY)).setUnlocalizedName("ruby_sword"));
        registerItem(443, "ruby_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.RUBY, 7, 0)).setUnlocalizedName("ruby_helmet"));
        registerItem(444, "ruby_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.RUBY, 7, 1)).setUnlocalizedName("ruby_chestplate"));
        registerItem(445, "ruby_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.RUBY, 7, 2)).setUnlocalizedName("ruby_leggings"));
        registerItem(446, "ruby_boots", (new ItemArmor(ItemArmor.ArmorMaterial.RUBY, 7, 3)).setUnlocalizedName("ruby_boots"));

        // Cobalt items
        registerItem(447, "cobalt_sword", (new ItemSword(Item.ToolMaterial.COBALT)).setUnlocalizedName("cobalt_sword"));
        registerItem(448, "cobalt_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.COBALT, 8, 0)).setUnlocalizedName("cobalt_helmet"));
        registerItem(449, "cobalt_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.COBALT, 8, 1)).setUnlocalizedName("cobalt_chestplate"));
        registerItem(450, "cobalt_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.COBALT, 8, 2)).setUnlocalizedName("cobalt_leggings"));
        registerItem(451, "cobalt_boots", (new ItemArmor(ItemArmor.ArmorMaterial.COBALT, 8, 3)).setUnlocalizedName("cobalt_boots"));

        // ── Blocs de minerai custom ───────────────────────────────────────────────
        registerItemBlock(Blocks.ruby_ore);
        registerItemBlock(Blocks.cobalt_ore);
        registerItemBlock(Blocks.steel_chest);
        ...
        registerItem(453, "ruby", (new Item()).setUnlocalizedName("ruby").setCreativeTab(CreativeTabs.tabMaterials));
        registerItem(454, "cobalt_ingot", (new Item()).setUnlocalizedName("cobalt_ingot").setCreativeTab(CreativeTabs.tabMaterials));

        // ── Outils Steel ─────────────────────────────────────────────────────────
        registerItem(455, "steel_pickaxe", (new ItemPickaxe(Item.ToolMaterial.STEEL)).setUnlocalizedName("steel_pickaxe"));
        registerItem(456, "steel_shovel", (new ItemSpade(Item.ToolMaterial.STEEL)).setUnlocalizedName("steel_shovel"));
        registerItem(457, "steel_axe", (new ItemAxe(Item.ToolMaterial.STEEL)).setUnlocalizedName("steel_axe"));
        registerItem(458, "steel_hoe", (new ItemHoe(Item.ToolMaterial.STEEL)).setUnlocalizedName("steel_hoe"));

        // ── Outils Emeraude ───────────────────────────────────────────────────────
        registerItem(459, "emerald_pickaxe", (new ItemPickaxe(Item.ToolMaterial.EMERALD)).setUnlocalizedName("emerald_pickaxe"));
        registerItem(460, "emerald_shovel", (new ItemSpade(Item.ToolMaterial.EMERALD)).setUnlocalizedName("emerald_shovel"));
        registerItem(461, "emerald_axe", (new ItemAxe(Item.ToolMaterial.EMERALD)).setUnlocalizedName("emerald_axe"));
        registerItem(462, "emerald_hoe", (new ItemHoe(Item.ToolMaterial.EMERALD)).setUnlocalizedName("emerald_hoe"));

        // ── Outils Ruby ────────────────────────────────────────────────────────────
        registerItem(463, "ruby_pickaxe", (new ItemPickaxe(Item.ToolMaterial.RUBY)).setUnlocalizedName("ruby_pickaxe"));
        registerItem(464, "ruby_shovel", (new ItemSpade(Item.ToolMaterial.RUBY)).setUnlocalizedName("ruby_shovel"));
        registerItem(465, "ruby_axe", (new ItemAxe(Item.ToolMaterial.RUBY)).setUnlocalizedName("ruby_axe"));
        registerItem(466, "ruby_hoe", (new ItemHoe(Item.ToolMaterial.RUBY)).setUnlocalizedName("ruby_hoe"));

        // ── Outils Cobalt ──────────────────────────────────────────────────────────
        registerItem(467, "cobalt_pickaxe", (new ItemPickaxe(Item.ToolMaterial.COBALT)).setUnlocalizedName("cobalt_pickaxe"));
    ...
    public static enum ToolMaterial {
        ...
        public Item getRepairItem() {
            if (this == WOOD) return Item.getItemFromBlock(Blocks.planks);
            if (this == STONE) return Item.getItemFromBlock(Blocks.cobblestone);
            if (this == GOLD) return Items.gold_ingot;
            if (this == IRON) return Items.iron_ingot;
            if (this == DIAMOND) return Items.diamond;
            if (this == EMERALD) return Items.emerald;
            if (this == STEEL) return itemRegistry.getObject(new ResourceLocation("steel_ingot"));
            if (this == RUBY) return itemRegistry.getObject(new ResourceLocation("ruby"));
            if (this == COBALT) return itemRegistry.getObject(new ResourceLocation("cobalt_ingot"));
            return null;
        }
    }
}
