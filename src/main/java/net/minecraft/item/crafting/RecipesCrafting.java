...
public class RecipesCrafting
{
    ...
    public void addRecipes(CraftingManager p_77589_1_)
    {
        ...
        // ── Acier : fer + charbon (shapeless) → lingot d'acier ───────────────────
        p_77589_1_.addShapelessRecipe(new ItemStack(Items.steel_ingot), new Object[] {Items.iron_ingot, Items.coal});

        // ── Coffre en Acier : 8 lingots d'acier autour d'un coffre normal ────────
        p_77589_1_.addRecipe(new ItemStack(Blocks.steel_chest), new Object[] {
            "SSS", "SCS", "SSS",
            'S', Items.steel_ingot,
            'C', Blocks.chest
        });
