...
public class ItemArmor extends Item {
     ...
     */
    // ── EnumArmorMaterial ───────────────────────────────────────────────────────────
    // Paramètres : nom, DURABILITÉ (factor), [protection casque/plastron/jamb/bot], enchantabilité
    // Durabilité finale = factor × {bottes=11, plastron=16, jambières=15, casque=13}
    // Exemple: DIAMOND factor=33 → casque=429, plastron=528, jambières=495, bottes=363
    public static enum ArmorMaterial {
        ...
        public Item getRepairItem() {
            if (this == LEATHER) return Items.leather;
            if (this == CHAIN) return Items.iron_ingot;
            ...
            if (this == STEEL) return Items.steel_ingot;
            if (this == RUBY) return Items.ruby;
            if (this == COBALT) return Items.cobalt_ingot;
            return null;
        }
